...
VOID IO_ShortSleep_Enter()
{
    ...
    P2DIR = CRYSTAL_32KHZ_PIN1_INV | CRYSTAL_32KHZ_PIN2_INV | OSC_PIN_INV | MOTION_SENSOR_INV | LED_GREEN_PIN | BATTERY_ADC_INPUT_INV | RF_ANTENNA2     | RF_ANTENNA1;
    P2OUT = CRYSTAL_32KHZ_PIN1_INV | CRYSTAL_32KHZ_PIN2_INV | OSC_PIN_INV | MOTION_SENSOR_INV | LED_GREEN_INV | BATTERY_ADC_INPUT_INV | RF_ANTENNA2_INV | RF_ANTENNA1_INV;
